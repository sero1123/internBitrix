			...
			<div class="col-sm-8 col-md-9">
					...
					<div class="col-xs-12">
						<div class="product-item-detail-tabs-container">
							<ul class="product-item-detail-tabs-list">
								...
								<li class="product-item-detail-tab" data-entity="tab" data-value="youtube">
									<a href="javascript:void(0);" class="product-item-detail-tab-link">
										<span>ютуб</span>
									</a>
								</li>
				...
				<div class="row" id="<?=$itemIds['TAB_CONTAINERS_ID']?>">
					<div class="col-xs-12">
						...
						?>
						<div class="product-item-detail-tab-content" data-entity="tab-container" data-value="youtube">
							<iframe width="560" height="315" src="<?=$arResult['PROPERTIES']['YOUTUBE']['VALUE']["TEXT"]?>"; frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
						</div>
					</div>
				</div>
			</div>
...
<?
echo "<pre>";
print_r($arResult['PROPERTIES']['YOUTUBE']['VALUE']["TEXT"]);
