...
$paramElem = array_merge($paramCatalogElement, $_SESSION["params"]);

// echo "<pre>";
// foreach ($paramElem as $key=>$value)
// {
// 	if($paramElem[$key] != $myParam[$key]){
// 		echo "<br>";
// 		print_r($key);
// 		echo "<br>";

// 		echo "параметры сессии" . "<br>";
// 		print_r($paramElem[$key]);
// 		echo "<br>";

// 		echo "параметры элемента" . "<br>";
// 		print_r($myParam[$key]);
// 		echo "<br>";
